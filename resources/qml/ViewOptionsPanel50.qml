    ...
    Item {
        ...
        Row
        {
            ...
            UM.SimpleButton
            {
                ...
                iconSource:
                {
                    ...
                    {
                        return Qt.resolvedUrl("../icons/view_perspective.svg")
                    }
                    else
                    {
                        return Qt.resolvedUrl("../icons/view_orthographic.svg")
                    }
                }
                onClicked:
                {
        ...
        Item
        {
            ...
            UM.SimpleButton
            {
                ...
                iconSource: legendItems.visible ? UM.Theme.getIcon("ChevronSingleDown") : UM.Theme.getIcon("ChevronSingleLeft")
